...
import com.mehedi.beans.UserBean;
import com.mehedi.constants.IUserConstants;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public String updateUserDetails(UserBean user) {
        ...
        try {
            ...
            ps = conn.prepareStatement("UPDATE " + IUserConstants.TABLE_USER + " SET name=?, mobile=?, address=?, pincode=? WHERE email=?");
